  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="background-color:#f7f9fc;border:1px solid #dde3ed;border-top:none;">
    <tr>
      <td style="padding:14px 18px;">
        <p style="margin:0 0 10px 0;color:#0A2342;font-size:11px;font-family:Arial,sans-serif;font-weight:700;letter-spacing:0.5px;">📖 ORDLISTA</p>
        <table width="100%" cellpadding="0" cellspacing="0">
          <tr>
            <td style="padding:4px 8px 4px 0;vertical-align:top;width:50%;">
              <p style="margin:0;font-family:Arial,sans-serif;font-size:11px;line-height:1.55;">
                <span style="display:inline-block;background:#0A2342;color:#C9A84C;font-size:9px;font-weight:700;padding:1px 5px;border-radius:2px;margin-bottom:3px;font-family:Courier,monospace;">NAV %</span><br>
                <strong style="color:#333;font-size:10px;">NAV-rabatt / premie</strong><br>
                <span style="color:#6b7a94;font-size:10px;">Skillnaden mellan aktiekurs och beräknat substansvärde. Negativt = rabatt (aktien billigare än tillgångarna). Positivt = premie.</span>
              </p>
            </td>
            <td style="padding:4px 0 4px 8px;vertical-align:top;width:50%;">
              <p style="margin:0;font-family:Arial,sans-serif;font-size:11px;line-height:1.55;">
                <span style="display:inline-block;background:#0A2342;color:#C9A84C;font-size:9px;font-weight:700;padding:1px 5px;border-radius:2px;margin-bottom:3px;font-family:Courier,monospace;">DIR %</span><br>
                <strong style="color:#333;font-size:10px;">Direktavkastning</strong><br>
                <span style="color:#6b7a94;font-size:10px;">Senast deklarerad årlig utdelning delat med aktuell kurs. Anger hur stor del av investeringen som återbetalas i utdelning per år.</span>
              </p>
            </td>
          </tr>
          <tr>
            <td style="padding:8px 8px 4px 0;vertical-align:top;">
              <p style="margin:0;font-family:Arial,sans-serif;font-size:11px;line-height:1.55;">
                <span style="display:inline-block;background:#0A2342;color:#C9A84C;font-size:9px;font-weight:700;padding:1px 5px;border-radius:2px;margin-bottom:3px;font-family:Courier,monospace;">P/E</span><br>
                <strong style="color:#333;font-size:10px;">Pris / Vinst</strong><br>
                <span style="color:#6b7a94;font-size:10px;">Aktiekurs delat med vinst per aktie. Hur många gånger årsvinsten betalar du? Högt P/E = höga förväntningar, lågt P/E kan indikera undervärderad aktie.</span>
              </p>
            </td>
            <td style="padding:8px 0 4px 8px;vertical-align:top;">
              <p style="margin:0;font-family:Arial,sans-serif;font-size:11px;line-height:1.55;">
                <span style="display:inline-block;background:#0A2342;color:#C9A84C;font-size:9px;font-weight:700;padding:1px 5px;border-radius:2px;margin-bottom:3px;font-family:Courier,monospace;">P/B</span><br>
                <strong style="color:#333;font-size:10px;">Pris / Bokfört värde</strong><br>
                <span style="color:#6b7a94;font-size:10px;">Aktiekurs delat med bokfört eget kapital per aktie. P/B under 1 = aktien handlas under redovisat tillgångsvärde — särskilt relevant för investmentbolag.</span>
              </p>
            </td>
          </tr>
        </table>
